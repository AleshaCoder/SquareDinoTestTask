...
namespace SWS
{
    ...
    public class navMove : MonoBehaviour, IService
    {
        /// <summary>
        ...
        /// Note that this includes a call when moveToPath starts.
        /// </summary>
        public UnityEvent movementPause;
        public event Action movementPauseEvent;
        ...
        public void Pause(float seconds = 0f)
        {
            ...
            movementPause?.Invoke();
            movementPauseEvent?.Invoke();
        }
